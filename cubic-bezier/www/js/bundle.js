...
/***/ function(module, exports, __webpack_require__) {
	...
	var Main = (function (_super) {
	    ...
	    Main.prototype.init = function () {
	        this.t = 0;
	        this.cbs = [];
	        this.cbs.push(bezier_1.default(0.455, 0.03, 0.515, 0.955, 20)); //easeInOutQuad
	        this.cbs.push(bezier_1.default(0.77, 0, 0.175, 1, 20)); //easeInOutQuart
	        this.cbs.push(bezier_1.default(1, 0, 0, 1)); //easeInOutExpo
	        this.cbs.push(bezier_1.default(0.68, -0.55, 0.265, 1.55, 20)); //easeInOutBack
	    };
...
/***/ function(module, exports) {
	...
	//2分探索もどきで探索
	function search(xtList, length, x) {
	    if (x == 0)
	        return 0;
	    if (x == 1)
	        return length - 2;
