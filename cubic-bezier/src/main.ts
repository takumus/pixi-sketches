...
export default class Main extends Canvas {
    ...
    public init() {
        this.t = 0;
        this.cbs = [];
        this.cbs.push(CubicBezier(0.455, 0.03, 0.515, 0.955)); //easeInOutQuad
        this.cbs.push(CubicBezier(0.77, 0, 0.175, 1)); //easeInOutQuart
        this.cbs.push(CubicBezier(1, 0, 0, 1)); //easeInOutExpo
        this.cbs.push(CubicBezier(0.68, -0.55, 0.265, 1.55)); //easeInOutBack
    }
    public draw() {
